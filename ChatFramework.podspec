...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Shehzad" => "Shehzad@fomarkmedia.com" }
  # Or just: spec.author    = "Shehzad"
  # spec.authors            = { "Shehzad" => "Shehzad@fomarkmedia.com" }
  # spec.social_media_url   = "https://twitter.com/Shehzad"
